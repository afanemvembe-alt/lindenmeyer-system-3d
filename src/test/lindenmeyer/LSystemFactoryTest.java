...
public class LSystemFactoryTest {
    ...
    static final LSystemFactory lSystemFactory = new LSystemFactory(ruleSep, partSep);
    ...
    void generation() {
        ...
        RuleSetFactory ruleSetFactory = new RuleSetFactory(ruleSep, partSep, sf);

        LSystem expectedLSystem = new LSystem(new Axiom(axiomString), ruleSetFactory.parseString(ruleString), sf);
        LSystem actualLSystem = lSystemFactory.parseString(axiomString, ruleString);
