...
public class AxiomTests{
	...
	public boolean getContentTest(){
		...
		boolean ok= axiomes.contains(s1) && axiomes.contains(s2) && axiomes.contains(s3) && axiomes.size()==3;
		if (!ok){ System.out.println("Erreur : getContent() incorrect pour Axiome");}
		return ok;
	}
	
	public boolean setContentTest(){
		...
		boolean ok= axiom1.getContent()==s1 && axiom2.getContent()==s2 && axiom3.getContent()==s3;
		if (!ok){ System.out.println("Erreur : setContent() incorrect pour Axiome");}
		return ok;
	}
	...
	public boolean isInAlphabetTest(){
		...
		if (!ok){ System.out.println("Erreur : isInAlphabet() incorrect pour Axiome");}
		return ok;
	}
